...
define('BLANK_DIAL', "img/_gac.png");	// A blank gauge Image
define('BLANK_IMG', "img/_gaa.png");			// A blank PNG Image
define('NEEDLE', "img/_gab.png");		// Our Needle Image
...
class Gauge{
	...
	function Gauge($value=0, $display_value = true, $range_bottom=0, $range_top=100)
	{
