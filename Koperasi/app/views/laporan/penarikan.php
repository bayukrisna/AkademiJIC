...
<form action="<?=site_url();?>/laporan/set_data" method="post" id="laporan" novalidate>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">Pencarian Data Penarikan Simpanan</h4>
        </div><!-- panel-heading -->
            ...
            <div class="row">
				...
				<div class="form-group">
					...
					<div style="margin-left:17.5%;">
						<br/><a href="javascript:void(0)" onclick="showPenarikan()" class="btn btn-primary" onClick="" /><i class="fa fa-search"></i>&nbsp;Cari</a>
...
<script>
	function showPenarikan(){
		if($("#periode_bulan").val()=="" || $("#sampai_bulan").val()==""){
			...
			$.ajax({
				type: 'POST',
				url: site_url + '/laporan/getPenarikan',
