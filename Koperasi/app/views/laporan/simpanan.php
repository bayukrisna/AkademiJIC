            ...
            <div class="row">
				...
				<div class="form-group">
					...
					<div style="margin-left:17.5%;">
						<br/><a href="javascript:void(0)" onclick="showSimpanan()" class="btn btn-primary" onClick="" /><i class="fa fa-search"></i>&nbsp;Cari</a>
...
<script>
	function showSimpanan(){
		if($("#periode_bulan").val()=="" || $("#sampai_bulan").val()==""){
			...
			$.ajax({
				type: 'POST',
				url: site_url + '/laporan/getSimpanan',
