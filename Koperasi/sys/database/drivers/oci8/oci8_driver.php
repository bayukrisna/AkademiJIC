...
class CI_DB_oci8_driver extends CI_DB {
	...
	{
	$insertinto = str_replace('\'to_date("', "to_date('", "INSERT INTO ".$table." (".implode(', ', $keys).") VALUES (".implode(', ', $values).")");
	$insertinto = str_replace('", \'yyyy-mm-dd', "', 'yyyy-mm-dd", $insertinto);
	$insertinto = str_replace("yyyy-mm-dd')'", "yyyy-mm-dd')", $insertinto);
	$insertinto = str_replace("'sysdate'", "sysdate", $insertinto);
	return $insertinto;
	}
